...
- Wallet Brick is currently in a migrations proccess. For now, it is only available for Brazil, Chile, Colombia, Mexico, Peru, and Uruguay. The integration structure will soon change to accommodate new integrations, but the current one will continue to work.
